...
- 3，手动将ros与gazebo联系起来
	...
	![[Pasted image 20251004150833.png]]
	
	（4），rviz可视化部分
	![[Pasted image 20251004151125.png]]
	详见[[13，完成输出tf的流程]]
...
- 4，通过launch文件，一次性完成启动gazebo的完整流程：
	...
	写launch文件：![[Pasted image 20251004154247.png]]
	（注意这里这个启动gz_sim第二步，这个文件路径）
	![[Pasted image 20251004154407.png]]
	![[Pasted image 20251004154423.png]]
	
	注意这里用到很多个pkg，所以在package.xml里面要加入依赖！
	![[Pasted image 20251004154516.png]]
...
- 5，使用 YAML 配置文件启动 ros_gz_bridge
	...
	![[Pasted image 20251005135756.png]]
	*通过把具体传输的话题写到yaml文件里面，然后当做参数放到ros_gz_bridge后面*
	
	![[Pasted image 20251005135921.png]]
	这个写法都是：
	-ros_topic_name: ""
	gz_topic_name: ""
	ros_type_name: ""
	...
	这个网站去找对应的ros侧数据类型
	![[Pasted image 20251005140649.png]]
	
	
	direction就是哪侧传到那侧的事情了。
	
	执行完就是这样的：![[Pasted image 20251005140833.png]]
	...
	![[Pasted image 20251005144234.png]]
	
	可以简单地通过手动发送这个话题的命令来控制
	ros2 topic pub /cmd_vel geometry_msgs/msg/Twist "linear: {x: 0.5}"
	![[Pasted image 20251005144313.png]]
	也可以通过twist控制器来控制
	ros2 run teleop_twist_keyboard teleop_twist_keyboard
	![[Pasted image 20251005144343.png]]


- 6，在gazebo里面创建环境，和保存环境
	![[Pasted image 20251005150635.png]]
	![[Pasted image 20251005150706.png]]
	更多的模型文件在这个网站下载
	https://app.gazebosim.org/fuel/models?page=1&per_page=20
	下载完解压完就是![[Pasted image 20251005150825.png]]
	这个dae就是单独的物体文件
	![[Pasted image 20251005150920.png]]
	然后选择那个下载下来的物体模型就行
	...
	*保存世界环境*
	...
	（2）![[Pasted image 20251005151109.png]]
	![[Pasted image 20251005151145.png]]
