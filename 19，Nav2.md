...
![[Pasted image 20251021213412.png]]
...
![[Pasted image 20251021214816.png]]
...
![[Pasted image 20251021220840.png]]
...
![[Pasted image 20251101141239.png]]
...
ros2 run turtlebot3_teleop teleop_keyboard 
```
![[Pasted image 20251101142317.png]]
...
![[Pasted image 20251101142803.png]]

这个pgm就是地图的图片，这个yaml里面包含着地图的一些信息：
![[Pasted image 20251101144508.png]]
...
还有一种查看地图信息的方式是
![[Pasted image 20251101145256.png]]
![[Pasted image 20251101145312.png]]
...
![[Pasted image 20251102131757.png]]


【3】点击2d位姿估计，给机器人设定一个大概的目前的位置在哪里，不需要太精确它会自己匹配
![[Pasted image 20251102131911.png]]
![[Pasted image 20251102131924.png]]
![[Pasted image 20251102131931.png]]
看到机器人附近这个扫描的雷达线跟地图的线匹配，就说明位置是对的


【4】点nav2 goal 就可以进行导航
![[Pasted image 20251102132054.png]]

【5】使用waypoints，导航多个路径点
![[Pasted image 20251102133534.png]]
![[Pasted image 20251102133547.png]]


使用第一个选项through poses的话，就是不会每个点都停下来，它会连贯地通过每个点
![[Pasted image 20251102133916.png]]


【6】同时，nav2有动态避障的功能
![[Pasted image 20251102135233.png]]
这里我们先选定一个点，然后点击暂停，再放置一个障碍物在路径中间，再点击继续
![[Pasted image 20251102135310.png]]
会发现它扫描到了障碍物，然后选择换了一条路走


### 6,global planner（重要）
全局规划是直接通过地图来进行路径规划的，一般用的是迪杰斯特拉 or A星算法，会规划出一条淡红色的路径，根据的是一个叫costmap的东西
![[Pasted image 20251102141517.png]]
![[Pasted image 20251102141627.png]]
这些有颜色的地方就是costmap
...
![[Pasted image 20251102142254.png]]
...
所以这里nav2融合了两种坐标的优点。
![[Pasted image 20251102214013.png]]


### 11,nav2的构建层次


![[Pasted image 20251102215027.png]]
...
【3】修改图像
![[Pasted image 20251102221327.png]]
...
![[Pasted image 20251103195919.png]]
...
```
他就输出一些信息
![[Pasted image 20251103200155.png]]
...
这里也只是显示一些信息
![[Pasted image 20251103200432.png]]
...
- 手动添加tf
	![[Pasted image 20251103200607.png]]

- 手动添加map
	![[Pasted image 20251103200639.png]]
	一开始会有一个错误，因为他不知道订阅哪个地图话题。你要手动选择话题/map
	![[Pasted image 20251103200731.png]]
	![[Pasted image 20251103200837.png]]

- 手动添加雷达信息（可选）
	![[Pasted image 20251103200936.png]]
	也是要选择订阅正确的话题/scan
	![[Pasted image 20251103201022.png]]

- 手动添加机器人模型（可选）
	![[Pasted image 20251103201132.png]]
	依然是要选择一下正确的话题订阅
	![[Pasted image 20251103201203.png]]


![[Pasted image 20251103201339.png]]
这样就跟之前的效果一样了
...
然后控制机器人移动，扫图
![[Pasted image 20251103201807.png]]
...
这里依旧是只显示一些信息
![[Pasted image 20251103202558.png]]
...
![[Pasted image 20251104185201.png]]
...
![[Pasted image 20251103202922.png]]![[Pasted image 20251103203006.png]]


可以看到最上面还是有问题，是因为还没有进行2d位姿估计

进行2d位姿估计
![[Pasted image 20251103203219.png]]

到这里其实差不多了

当然可以再添加两个地图，就是global costmap和loacl costmap（就是map，只是重命名了，并且订阅的话题也不一样）
![[Pasted image 20251103203348.png]]![[Pasted image 20251103203527.png]]

添加全局规划的路径显示和局部路径的显示
![[Pasted image 20251104165226.png]]
...
![[Pasted image 20251104161622.png]]

或者就是用rviz的publish point功能，它会发布一个话题信息，然后你在终端里面接收它就能看到点位信息了
![[Pasted image 20251104163522.png]]
```
...
![[Pasted image 20251104194350.png]]
![[Pasted image 20251104194405.png]]
